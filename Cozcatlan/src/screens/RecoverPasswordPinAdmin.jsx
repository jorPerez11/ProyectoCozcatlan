...
export const RecoverPasswordPinAdmin = () => {
    ...
    const handleNext = async (e) => {
        ...
        // Recuperamos el correo que guardamos en la primera pantalla de administradores
        ...
        try {
            ...
            // Guardamos el pin validado específicamente para el flujo del administrador
            sessionStorage.setItem("recoveryPinAdmin", pin.trim());
            toast.success("Código verificado correctamente");
            
            // Avanzamos al último paso de administradores
            navigate('/recoveryNewPasswordAdmin'); 
        } catch (error) {
        ...
        <div className="signup-wrapper">
            <main className="container d-flex align-items-center justify-content-center min-vh-100">
                <div className="signup-card p-4 p-md-5 shadow-lg">
                    ...
                    <p className="text-muted small mb-4">Portal de Personal. Ingresa el pin de acceso que se envió a tu correo electrónico de administrador</p>
                    ...
                    <form onSubmit={handleNext}>
                        ...
                        <div className='buttonsFlex'>
                            <button 
                                type="button" 
                                onClick={() => navigate('/recoveryPasswordAdmin')} 
...
export default RecoverPasswordPinAdmin;