...
export const RecoverPasswordEmployee = () => {
    ...
    const handleNext = async (e) => {
        ...
        try {
            ...
            // Guardamos el correo en una clave exclusiva para empleados
            sessionStorage.setItem("recoveryEmailEmployee", email.trim());
            toast.success(data?.message || "Código de recuperación enviado a tu correo");

            // Avanzamos a la pantalla del PIN del empleado
            navigate('/recoveryPasswordPinEmployee');
        } catch (error) {
        ...
        <div className="signup-wrapper">
            <main className="container d-flex align-items-center justify-content-center min-vh-100">
                <div className="signup-card p-4 p-md-5 shadow-lg">
                    ...
                    <p className="text-muted small mb-4">Bienvenido. Empecemos con la recuperación de su contraseña de empleado.</p>

                    <form onSubmit={handleNext}>
                        <CustomInput
                            label="Dirección de correo electrónico institucional"
                            type="email"
...
export default RecoverPasswordEmployee;