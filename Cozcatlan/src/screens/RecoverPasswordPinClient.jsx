...
export const RecoverPasswordPinClient = () => {
    ...
    const handleNext = async (e) => {
        ...
        try {
            ...
            // Guardamos temporalmente el código validado para usarlo en el cambio final de contraseña
            sessionStorage.setItem("recoveryPinClient", pin.trim());
            toast.success("Código verificado correctamente");
            
            // Avanzamos al último paso del cliente
            navigate('/recoveryNewPasswordClient'); 
        } catch (error) {
        ...
        <div className="signup-wrapper">
            <main className="container d-flex align-items-center justify-content-center min-vh-100">
                <div className="signup-card p-4 p-md-5 shadow-lg">
                    ...
                    <p className="text-muted small mb-4">Ingresa el pin de acceso que se envió a tu correo electrónico</p>
                    ...
                    <form onSubmit={handleNext}>
                        ...
                        <div className='buttonsFlex'>
                            <button 
                                type="button" 
                                onClick={() => navigate('/recoveryPasswordClient')} 
...
export default RecoverPasswordPinClient;