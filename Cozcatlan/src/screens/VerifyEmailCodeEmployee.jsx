...
export const VerifyEmailCode = () => {
    ...
    const API_VERIFY = "http://localhost:4000/api/employee/registerEmployee/verifyCodeEmail"; // URL del endpoint para verificar el código OTP
    const API_REGISTER = "http://localhost:4000/api/employee/registerEmployee"; // URL del endpoint para registrar un nuevo usuario (utilizado para reenviar el código OTP)
